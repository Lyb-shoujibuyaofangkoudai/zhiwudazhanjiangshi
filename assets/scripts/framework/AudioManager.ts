...
import { lodash } from "db://assets/scripts/utils/lodash";
import { resourceUtil } from "db://assets/scripts/utils/resourceUtil";
...
export class AudioManager {
    private _source_path = "music/"
    private _persistRootNode: Node = null!; // 常驻节点
    ...
    init() {
        ...
        this.musicVolume = this.getAudioSetting(true) ? .8 : 0;
    ...
    playMusic(name: string, loop: boolean) {
        let path = this._source_path + name;
